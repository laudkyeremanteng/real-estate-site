        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              {/* Contact Information */}
              <div className="mb-6">
                <h2 className="text-2xl font-heading font-bold text-gold mb-4">Contact Agent</h2>
                <div className="space-y-3">
                  {property.whatsapp && (
                    <div className="flex items-center text-gray-300 font-body">
                      ...
                      <span className="text-gold font-semibold">WhatsApp:</span> {property.whatsapp}
                    </div>
                  )}
                  {property.phone && (
                    <div className="flex items-center text-gray-300 font-body">
                      ...
                      <span className="text-gold font-semibold">Phone:</span> {property.phone}
                    </div>
                  )}
                </div>
              </div>
