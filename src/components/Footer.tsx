// =================================================================
// FOOTER COMPONENT - Delta Homes Gh Real Estate Website
// =================================================================
// Purpose: Site footer with navigation, links, and company information
// Contains: Company branding, navigation links, social media, copyright
// Used by: All pages
// =================================================================

import Link from 'next/link'

// Footer component with company information and navigation
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Your relentless real estate sales, investments & developers. 
              Discover exclusive properties in Ghana's most prestigious neighborhoods.
            </p>
